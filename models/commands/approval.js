module.exports.config = {
	...
	hasPermssion: 2,
	credits: "uzairrajput",
	description: "THIS BOT MADE BY UZAIR RAJPUT MTX",
  ...
  switch (type) {
        case "pending": {
          switch (body) {
   			...
   			api.sendMessage(`𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝑼𝒛𝒂𝒊𝒓 𝑹𝒂𝒋𝒑𝒖𝒕 𝐁𝐨𝐭 😇👈
=𝐎𝐰𝐧𝐞𝐫 ➻    ⎯꯭𝁂꯭꯭꯭֯✰🩷꯭꯬꯭𓆩〭ͥ〬 ⃪ᷟ꯬༏❤️𝆺𝅥Ʀ𝐮𝐭𝐢𝐤𝆺𝅥🫰❤️⎯꯭̽𝆭⎯ ──────────────── 💚✨ 𝐀𝐩 𝐊𝐚 𝐆𝐫𝐎𝐮𝐏 𝐀𝐩𝐏𝐑𝐨𝐕𝐚𝐋 𝐊𝐚𝐑 𝐃𝐢𝐘𝐚 𝐇𝐚𝐈 =𝐎𝐰𝐧𝐞𝐫 ➻   ⎯꯭𝁂꯭꯭꯭֯✰🩷꯭꯬꯭𓆩〭ͥ〬 ⃪ᷟ꯬༏❤️𝆺𝅥Ʀ𝐮𝐭𝐢𝐤𝆺𝅥🫰❤️⎯꯭̽𝆭⎯\n${idBox}`, threadID, () => {
...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] Your group has been removed from the browsing list by the admin for the reason: ${lydo}`, idBox);
   	...
   	else api.sendMessage("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨✮⃝❤≛⃝ R𝐮𝐭𝐢𝐤──────亗🕊️-𝑴𝑻𝑿 𝐁𝐨𝐭 😇◈ ────────────────  𝐀𝐩 𝐊𝐚 𝐆𝐫𝐎𝐮𝐏 𝐀𝐩𝐏𝐑𝐨𝐕𝐚𝐋 𝐊𝐚𝐑 𝐃𝐢𝐘𝐚 𝐇𝐚𝐈 𝐎𝐰𝐧𝐞𝐫 ➻   ⎯꯭𝁂꯭꯭꯭֯✰🩷꯭꯬꯭𓆩〭ͥ〬 ⃪ᷟ꯬༏❤️𝆺𝅥Ʀ𝐮𝐭𝐢𝐤𝆺𝅥🫰❤️⎯꯭̽𝆭⎯ \n◈ ──────────────── 💚✨\n◈ ──── 💚✨  𝐀𝐁𝐁  𝐊𝐀𝐑𝐎  𝐌𝐀𝐒𝐓𝐈 ◈ ──── 💚✨ \n◈ ──────────────── 💚✨\n=𝐎𝐰𝐧𝐞𝐫 ➻    ⎯꯭𝁂꯭꯭꯭֯✰🩷꯭꯬꯭𓆩〭ͥ〬 ⃪ᷟ꯬༏❤️𝆺𝅥Ʀ𝐮𝐭𝐢𝐤𝆺𝅥🫰❤️⎯꯭̽𝆭⎯\n◈ ──────────────── 💚✨\n𝐀𝐩𝐤𝐀 𝐏𝐈𝐲𝐑𝐚 𝐎𝐰𝐧𝐞𝐫 ➻  ⎯꯭𝁂꯭꯭꯭֯✰🩷꯭꯬꯭𓆩〭ͥ〬 ⃪ᷟ꯬༏❤️𝆺𝅥Ʀ𝐮𝐭𝐢𝐤𝆺𝅥🫰❤️⎯꯭̽𝆭⎯ https://www.facebook.com/share/1FdhERe3cp/ 𝐢𝐝 𝐥𝐢𝐧𝐤 😊👈 ⎯꯭𝁂꯭꯭꯭֯✰🩷꯭꯬꯭𓆩〭ͥ〬 ⃪ᷟ꯬༏❤️𝆺𝅥Ʀ𝐮𝐭𝐢𝐤𝆺𝅥🫰❤️⎯꯭̽𝆭⎯ :- ☞ https://www.facebook.com/share/17ntW3yugs/ ──────────────── 💚✨\n𝐊𝐢𝐒𝐢 𝐁𝐡𝐈 𝐓𝐚𝐑𝐇𝐚 𝐊𝐢 𝐇𝐞𝐋𝐩 𝐋𝐚𝐍𝐢 𝐇𝐨 𝐀𝐛𝐇𝐢 𝐌𝐞𝐒𝐒𝐠 𝐊𝐚𝐑𝐞 𝐎𝐰𝐧𝐞𝐫 ➻  ⎯꯭𝁂꯭꯭꯭֯✰🩷꯭꯬꯭𓆩〭ͥ〬 ⃪ᷟ꯬༏❤️𝆺𝅥Ʀ𝐮𝐭𝐢𝐤𝆺𝅥🫰❤️⎯꯭̽𝆭⎯◈ ──────────────── 💚✨ 👉 [+92 9921😝😝]", idBox, (error, info) => {
