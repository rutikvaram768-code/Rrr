...
"https://i.imgur.com/NcbC8Pn.jpg",
  ...
  var Rutik2 = () => api.sendMessage({ body: Uzairrajput3, attachment: fs.createReadStream(__dirname + "/cache/Uzairrajput1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/Uzairrajput1.jpg"), event.messageID);
