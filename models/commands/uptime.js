module.exports.config = {
	...
	version: "1.0.0",
	hasPermssion: 1,
	credits: "uzairrajput ",//Modified by MrUzairXxX-MTX
  hide: true,
...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("Uzair", 930, 540)
    ctx.fillText("MTX", 930, 610)
    ctx.fillText("Kiran Rajput", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
